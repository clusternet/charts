...
| `image.tag`                 | clusternet-hub image tag (immutable tags are recommended)                                 | `v0.8.0`                                                                                                                  |
...
| `extraArgs`                 | Additional command line arguments to pass to clusternet-hub                               | `{"v":4,"feature-gates":"SocketConnection=true,Deployer=true,ShadowAPI=true,FeedInUseProtection=true,FeedInventory=true}` |
